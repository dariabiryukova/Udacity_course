...
/**
 * Created by bivy on 17/09/14.
 */
public class WeatherContract {

    //Content authority is a name for the entire content provider,
    //similar to the relationship between a domain name and its websites. A convenient string to use for the
    //content authority is the package name for the app, which is guaranteed to be unique on
    // the device.
    public static final String CONTENT_AUTHORITY = "com.example.bivy.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static final String COLUMN_LOCATIONSETTINGS = "location_sett";
